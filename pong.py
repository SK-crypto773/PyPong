...
basic_font = pygame.font.SysFont("identifythisfont", 120)
game_over_font_big = pygame.font.SysFont("identifythisfont", 72)
game_over_font_small = pygame.font.SysFont("identifythisfont", 50)
